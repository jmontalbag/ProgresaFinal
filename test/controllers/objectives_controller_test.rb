...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post objectives_url, params: { objective: { classification_id: @objective.classification_id, texto: @objective.texto, zone_id: @objective.zone_id } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { classification_id: @objective.classification_id, texto: @objective.texto, zone_id: @objective.zone_id } }
