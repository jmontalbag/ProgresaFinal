...
class BeneficiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beneficiary" do
    assert_difference('Beneficiary.count') do
      post beneficiaries_url, params: { beneficiary: { apellido: @beneficiary.apellido, fecha_nac: @beneficiary.fecha_nac, nombre: @beneficiary.nombre, rut: @beneficiary.rut } }
    end
  ...
  test "should update beneficiary" do
    patch beneficiary_url(@beneficiary), params: { beneficiary: { apellido: @beneficiary.apellido, fecha_nac: @beneficiary.fecha_nac, nombre: @beneficiary.nombre, rut: @beneficiary.rut } }
